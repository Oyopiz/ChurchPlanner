...
import com.elitechinc.churchplanner.Classes.ItemData;
import com.elitechinc.churchplanner.Classes.MovieDetailsEntry;
import com.elitechinc.churchplanner.Classes.MyData;
import com.elitechinc.churchplanner.Classes.MyDatePicker;
import com.elitechinc.churchplanner.Classes.userDB;
...
import static com.elitechinc.churchplanner.R.id.listPictures;
import static com.elitechinc.churchplanner.R.id.showStart;
import static com.elitechinc.churchplanner.R.layout.activity_movie_scheduler;
...
public class MovieScheduler extends AppCompatActivity implements View.OnClickListener{
    ...
    private String[] names = {"Kabarak chapel prayers", "Rafiki AIc church", "KIamunyi AIc church", "Kabarak friday Fellowship", "Tuesday fellowship kabarak", "Kabarak chapel"};
    private userDB db;
    int flag=1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movie_scheduler);
        ...
        switch (v.getId()) {
            ...
            case R.id.btnSchedule:
                ...
                if(selectedMovie == null) {
                    Toast.makeText(MovieScheduler.this, "Please select church  service to proceed ", Toast.LENGTH_LONG).show();
                    break;
